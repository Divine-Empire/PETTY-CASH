    ...
    <div className="space-y-10 animate-in fade-in duration-1000">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
        <div className="animate-in slide-in-from-left duration-700">
          ...
          <h1 className="text-4xl font-black text-slate-900 tracking-tight leading-none mb-2">Dashboard</h1>
        ...
        <div className="flex items-center gap-3 pt-1 animate-in slide-in-from-right duration-700">
          <button
            onClick={exportCSV}
            className="inline-flex items-center gap-2.5 bg-white border border-slate-200 text-slate-700 px-5 py-3 rounded-2xl text-sm font-bold shadow-sm hover:border-emerald-300 hover:text-emerald-700 hover:bg-emerald-50 transition-all duration-300 active:scale-95 group"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2.5 bg-slate-900 text-white px-5 py-3 rounded-2xl text-sm font-bold shadow-xl shadow-slate-200 hover:bg-slate-800 transition-all duration-300 active:scale-95 group"
          >
        ...
        <div className="px-6 py-5">
          <div className="flex flex-col lg:flex-row lg:items-center gap-8">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-1.5 p-1.5 bg-slate-100/80 rounded-2xl border border-slate-200/30">
                {['All Expenses', 'Approved', 'Pending', 'Hold', 'Rejected'].map((opt) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-4 py-2 rounded-[14px] text-[11px] font-black tracking-wider transition-all duration-300 uppercase ${
                        isActive
            ...
            <div className="flex flex-col gap-3 flex-1">
              ...
              <div className="flex items-center gap-3">
                <div className="flex-1 flex items-center gap-3 bg-slate-50/80 hover:bg-white border border-slate-200 hover:border-indigo-300 rounded-2xl px-4 py-2.5 transition-all duration-300 group cursor-pointer shadow-sm">
                  ...
                  <div className="flex flex-col min-w-0">
                    ...
                    <input
                      ...
                      className="text-[13px] font-bold text-slate-800 bg-transparent border-none p-0 focus:ring-0 cursor-pointer"
                    />
                  </div>
                </div>
